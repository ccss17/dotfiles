...
[alias]
    ...
    cred = config credential.helper store
...
cat <<EOF >> ~/.p10k.zsh
# Generated by Powerlevel10k configuration wizard on 2025-01-16 at 11:27 KST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=121
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=121
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=121
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_LEFT_SUBSEGMENT_SEPARATOR=' '
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_RIGHT_SUBSEGMENT_SEPARATOR=' '
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_LEFT_SEGMENT_SEPARATOR=
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_BACKGROUND=
  typeset -g POWERLEVEL9K_DISK_USAGE_LEFT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_DISK_USAGE_RIGHT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_DISK_USAGE_LEFT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_DISK_USAGE_RIGHT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_DISK_USAGE_LEFT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_DISK_USAGE_RIGHT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_DISK_USAGE_LEFT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_DISK_USAGE_RIGHT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_DISK_USAGE_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=''
  typeset -g POWERLEVEL9K_DISK_USAGE_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL=''
  ...
  typeset -g POWERLEVEL9K_RAM_LEFT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_RAM_RIGHT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_RAM_LEFT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_RAM_RIGHT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_RAM_LEFT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_RAM_RIGHT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_RAM_LEFT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_RAM_RIGHT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_RAM_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=''
  typeset -g POWERLEVEL9K_RAM_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL=''
  typeset -g POWERLEVEL9K_RAM_ICON_PADDING=none
  typeset -g POWERLEVEL9K_RAM_MULTILINE_FIRST_PROMPT_GAP_CHAR=''
  typeset -g POWERLEVEL9K_RAM_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL=''
  typeset -g POWERLEVEL9K_RAM_RIGHT_PROMPT_LAST_SEGMENT_END_SYMBOL=''

  typeset -g POWERLEVEL9K_RAM_{LEFT,RIGHT}_{LEFT,RIGHT}_WHITESPACE=  # no surrounding whitespace
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=50
  typeset -g POWERLEVEL9K_LOAD_NORMAL_BACKGROUND=
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=50
  typeset -g POWERLEVEL9K_LOAD_WARNING_BACKGROUND=
  # Load color when load is over 70%.
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_FOREGROUND=50
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_BACKGROUND=
  # Custom icon.
  typeset -g POWERLEVEL9K_LOAD_VISUAL_IDENTIFIER_EXPANSION=''

  typeset -g POWERLEVEL9K_LOAD_BACKGROUND=
  typeset -g POWERLEVEL9K_LOAD_LEFT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LOAD_RIGHT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LOAD_LEFT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LOAD_RIGHT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LOAD_LEFT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LOAD_RIGHT_SUBSEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LOAD_LEFT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LOAD_RIGHT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LOAD_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=''
  typeset -g POWERLEVEL9K_LOAD_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL=''
  ...
  # Context format when running with privileges: user@vast_containerlabel.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%n@$(cat ~/.vast_containerlabel)'
  # Context format when in SSH without privileges: user@vast_containerlabel.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@$(cat ~/.vast_containerlabel)'
  # Default context format (no privileges, no SSH): user@vast_containerlabel.
  ...
  typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=255
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%m/%d %H:%M}'
  ...
  function prompt_mytest() {
    p10k segment -b 21 -f 15 -i '' -t 'zsh'
  }
  function prompt_myprompt() {
    p10k segment -b 21 -f 15 -i '' -t 'zsh'
  }
  function prompt_example() {
    p10k segment -b 1 -f 3 -i '⭐222' -t 'hello111, %n'
  }
